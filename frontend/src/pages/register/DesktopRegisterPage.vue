<!--
  本文件拥有桌面端首个用户注册页面，属于 frontend 鉴权页面层。
  它调用注册和登录 API 建立可恢复会话，不负责后续用户管理或路由守卫。
-->
<template>
  <main class="desktop-auth-page">
    <section class="desktop-auth-panel" aria-labelledby="desktop-register-title">
      <header class="desktop-auth-header">
        ...
        <div>
          ...
          <h1 id="desktop-register-title">创建首个用户</h1>
