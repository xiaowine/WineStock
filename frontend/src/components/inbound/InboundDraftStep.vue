        ...
        <table>
          ...
          <tbody>
            ...
            >
                ...
                <div class="inbound-line__identity">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <em
                        v-if="
                          line.templateSource === 'recommended' && line.templateState === 'ready'
                        "
                        >已推荐</em
                      >
                    </small>
              ...
              <td data-label="小计" class="inbound-line__subtotal">
    ...
    return {
      label:
        line.templateSource === "recommended"
          ? `推荐模板 #${line.templateId} 已失效`
          : `模板 #${line.templateId} 已失效`,
      status: "需要处理",
      tone: "warning",
    };
  }
