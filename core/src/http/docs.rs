...
#[openapi(
    paths(
        ...
        crate::stock::controller::get_template,
        crate::stock::controller::update_template,
        crate::stock::controller::delete_template,
        crate::stock::controller::copy_template,
        crate::stock::controller::create_item,
        crate::stock::controller::list_items,
        crate::stock::controller::get_item,
        crate::stock::controller::update_item,
        crate::stock::controller::delete_item,
        crate::stock::controller::bind_substitutes,
        crate::stock::controller::list_substitutes,
        crate::stock::controller::delete_substitute,
        crate::stock::controller::create_inbound,
        crate::stock::controller::list_inbound,
        crate::stock::controller::get_inbound,
        crate::stock::controller::approve_inbound,
        crate::stock::controller::reject_inbound,
        crate::stock::controller::create_outbound,
        crate::stock::controller::list_outbound,
        crate::stock::controller::get_outbound,
        crate::stock::controller::approve_outbound,
        crate::stock::controller::reject_outbound,
        crate::stock::controller::dashboard_overview,
        crate::stock::controller::dashboard_trends,
        crate::stock::controller::list_events
    ),
    components(schemas(
        AuthRegisterRequest,
        AuthClientKind,
