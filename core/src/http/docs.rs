//! core 全局 Debug API 文档与 Swagger UI 装配。
//!
//! 本模块属于 `core axum library` 层，只负责 Debug 接口文档元信息和文档路由。
//! Release 构建不注册 OpenAPI JSON 或 Swagger UI；它不承载平台前端资源。
...
#[openapi(
    paths(
        ...
        crate::users::controller::update_user_username,
        ...
        crate::stock::controller::items::lookup_item_options,
        ...
        crate::stock::controller::item_lookup::lookup_lcsc_items,
    ...
    components(schemas(
        ...
        crate::users::controller::UserUsernameUpdateRequest,
        ...
        crate::stock::controller::ItemLookupSource,
        crate::stock::controller::LcscLookupParameterResponse,
        crate::stock::controller::LcscItemLookupResponse,
        crate::stock::controller::LcscBatchLookupRequest,
        crate::stock::controller::LcscBatchLookupError,
        crate::stock::controller::LcscBatchLookupResult,
        crate::stock::controller::LcscBatchLookupResponse,
        ...
        crate::stock::controller::ItemOptionLookupRequest,
        crate::stock::controller::ItemOptionLookupResponse,
        crate::stock::controller::ItemOptionLookupResult,
