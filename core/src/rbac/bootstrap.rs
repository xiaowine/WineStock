...
use crate::{
    ...
    stock::{
        ...
        STOCK_ITEM_MANAGE_PERMISSION, STOCK_ITEM_READ_PERMISSION, STOCK_LOCATION_MANAGE_PERMISSION,
        STOCK_LOCATION_READ_PERMISSION, STOCK_OUTBOUND_APPROVE_PERMISSION,
...
const BUILTIN_PERMISSIONS: &[BuiltinPermission] = &[
    ...
    BuiltinPermission {
        code: STOCK_LOCATION_MANAGE_PERMISSION,
        description: "管理库位分组、库位和整批次移库。",
    },
    BuiltinPermission {
        code: STOCK_LOCATION_READ_PERMISSION,
        description: "查看库位分组树和库位列表。",
    },
    BuiltinPermission {
    ...
    BuiltinPermission {
        code: DELETE_USER_PERMISSION,
        description: "软删除其他用户账号。",
    },
    BuiltinPermission {
