...
<p align="center">
  <img src="docs/images/desktop-dashboard.png" alt="WineStock 桌面端库存总览，展示浅色与深色主题" width="100%">
</p>

<p align="center"><em>桌面端库存总览：库存规模、库存价值、出入库趋势与需要关注的物品一目了然。</em></p>

<p align="center">
  <img src="docs/images/android-dashboard.png" alt="WineStock Android 端库存总览，展示浅色与深色主题" width="360">
</p>

<p align="center"><em>Android 端延续相同的业务体验，并为触控和窄屏调整信息布局。</em></p>
